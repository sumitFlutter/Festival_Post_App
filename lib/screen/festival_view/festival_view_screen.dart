...
class _FestivalViewScreenState extends State<FestivalViewScreen> {
  ...
  String? image = "assets/bg_images/1.jpg";
  List colorList = [
    Colors.black,
    Colors.white,
    ...Colors.primaries,
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: ListView(
                          ...
                          children: [
                            bgImage(back: "assets/bg_images/1.jpg"),
                            bgImage(
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) => InkWell(
                            ...
                            child: Container(
                              ...
                              child: bgColor==colorList[index]?const Icon(Icons.check,color: Colors.grey,):Container(),
                            ),
                          ))),
                               ),
                             ],
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) => InkWell(
                            ...
                            child: Container(
                              ...
                              child: textColor==colorList[index]?const Icon(Icons.check,color: Colors.grey,):Container(),
                            ),
                          ))),
                               ),
                               InkWell(
    ...
    return GestureDetector(
      ...
      child: Stack(
        ...
        children: [
          ...
          back==image?Icon(Icons.check,size: 50,):Container(),
        ],
      ),
    );
  }
