...
class _FestivalViewScreenState extends State<FestivalViewScreen> {
  ...
  List colorList=[Colors.black,Colors.white,...Colors.primaries,...Colors.accents];
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          centerTitle: true,
          title: const Text("Post - Edit",style: TextStyle(fontWeight: FontWeight.bold,fontFamily: "sumit"),),
        ),
            ...
            child: Column(
                  ...
                  children: [
                    ...
                    Container(
                     ...
                     child: Align(alignment: a,
                         child: Text("$text1",style: TextStyle(fontSize:font,color:textColor,fontWeight: fontWeight1?FontWeight.bold:FontWeight.normal,fontStyle:italic?FontStyle.italic:FontStyle.normal ),)),
                    ),
                  ],
                ):
                Stack(
             ...
             InkWell(onTap: () {
               setState(() {
                 ...
                 child: mainTitle(title1: "Background Edit", vi: background)),
             Visibility(
               visible: background,
               child: Column(
                 children: [
                       ...
                       children: [
                         SizedBox(
                           ...
                           child: ListView(
                             ...
                             children: [
                               bgImage(back:"assets/bg_images/splesh.jpg"),
                   ...
                   Visibility(
                     ...
                     child: SizedBox(
                         height: 60,
                         child: ListView.builder(itemCount: colorList.length,scrollDirection:Axis.horizontal,itemBuilder:(context, index) => InkWell(
                           onTap: () {
                             setState(() {
                               bgColor=colorList[index];
                             });
                           },
                           child: Container(height: 50,width: 50,margin:const EdgeInsets.all(2),decoration: BoxDecoration(
                        ...
                        child: Row(
                          ...
                          children: [
                            SizedBox(
                                ...
                                child: TextField(controller: s,textInputAction: TextInputAction.done,decoration: const InputDecoration(hintText: "Happy ....."),maxLines: 2,)),
                            SizedBox(
  ...
  Widget bgImage({required String? back})
  {
    return
      GestureDetector(
        ...
        child: Container(
          padding: const EdgeInsets.all(10),
              child: Image.asset("${back}",fit: BoxFit.fill, height: 100,
                width: 100,)),
      );
          ...
          children: [
            Container(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text(title1,style: const TextStyle(fontSize: 18),),
                  v?const Icon(Icons.arrow_drop_up):const Icon(Icons.arrow_drop_down),
                ],
              ),
            ),
            v?Container():const Divider(color: Colors.black87,),
          ],
        ),
    );
  }
        ...
        children: [
          Container(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text(title1,style: const TextStyle(fontSize: 22),),
                vi?const Icon(Icons.arrow_drop_up):const Icon(Icons.arrow_drop_down),
              ],
            ),
          ),
          vi?Container():const Divider(color: Colors.black87,),
        ],
      ),
    );
